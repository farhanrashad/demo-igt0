        ...
        for id in lines:
            ...
            if id.line_ids:
                ...
                for line in id.line_ids:
                    ...
                    updated_pr_amount  = line.price_total_base
                            ...
                            if order.line_ids:
                                for line_model in order.line_ids:
                                    if line_model.product_id.id == line.product_id.id:
                                        ...
                                        sheet.write(row, 11, pr_amount, format2)
                                        sheet.write(row, 12, updated_pr_amount, format2)
