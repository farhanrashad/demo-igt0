...
class DocumentsOrder(http.Controller):
    @http.route('/document/create/',type="http", website=True, auth='user')
    def document_upload_template(self, **kw):
        return request.render("de_portal_document_upload.upload_documents",docs_page_content())
...
class CustomerPortal(CustomerPortal):
    ...
    def portal_documents_docs(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, search=None,
...
#         domain = []
        ...
        return request.render("de_portal_document_upload.portal_documents_docs", values)
